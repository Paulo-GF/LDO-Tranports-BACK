...
const applyController = {
    sendApply: function (req, res) {
        ...
        const mailOptions = {
            ...
            <div style="color: white; font-size: 1.4em; font-weight: bold; position: relative; z-index: 2; width:800px; margin: 10px;"> Vous avez reçu une candidature pour le poste de <span style="font-weight: bold; background-color: rgba(64, 194, 211, 0.589); border-radius: 10px; padding: 5px;">${req.body.title}</span> </div>
